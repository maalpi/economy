      ...
      <SQLiteProvider databaseName='economy.db' onInit={initializeDatabase} useSuspense>
        <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
          <Stack>
            ...
            <Stack.Screen name="conta/index" options={{ title: 'voltar', animation: 'fade', headerTransparent: true, headerTintColor: '#fff', statusBarStyle:'dark', statusBarTranslucent: true }} />
